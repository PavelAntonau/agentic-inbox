...
// Ported from @cloudflare/kumo Badge (shadcn pattern — source in app/ui/).
// Preserves exact public API, prop names, and class names from kumo's badge chunk.

import type { ReactNode } from "react";
import { cn } from "~/ui/lib/cn";

// ---------------------------------------------------------------------------
// Base styles + variant table (mirrors KUMO_BADGE_BASE_STYLES / KUMO_BADGE_VARIANTS)
// ---------------------------------------------------------------------------
...
}: KumoBadgeVariantsProps = {}): string {
  const v = KUMO_BADGE_VARIANTS.variant[variant];
  return cn(
