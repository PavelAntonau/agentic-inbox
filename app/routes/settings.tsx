...
export default function SettingsRoute() {
  ...
  return (
    <div className="max-w-2xl px-4 py-4 md:px-8 md:py-6 h-full overflow-y-auto">
      <h1 className="text-lg font-semibold text-text-bright mb-6">Settings</h1>

      <div className="space-y-6">
        {/* Account */}
        <div className="rounded-lg border border-border bg-card p-5">
          <div className="text-sm font-medium text-text-bright mb-4">
            Account
          </div>
        ...
        <div className="rounded-lg border border-border bg-card p-5">
          ...
          <textarea
            ...
            rows={12}
            className="w-full resize-y rounded-lg border border-border bg-bg px-3 py-2 text-xs text-text-bright placeholder:text-text-muted focus:outline-none focus:ring-1 focus:ring-kumo-ring font-mono leading-relaxed"
          />
        ...
        {/* Visibility moved to /account in Phase 4 — per-user setting is no
            ...
            looking for it can find the new home. */}
        <p className="text-xs text-text-muted">
          Looking for visibility settings? They moved to{" "}
          <a
            href="/account"
