    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue/10">
              <PlugsIcon size={20} weight="duotone" className="text-blue" />
            </div>
            <div>
              <h3 className="text-sm font-semibold text-text-bright">
                Connect via MCP
              </h3>
              <p className="text-xs text-text-muted">Model Context Protocol</p>
            </div>
          </div>
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-medium text-text-bright block">
            Server URL
          </label>
        ...
        {/* Available tools */}
        <div className="space-y-2">
          <h4 className="text-xs uppercase tracking-wider font-semibold text-text-muted px-0.5">
            Available Tools
          </h4>
