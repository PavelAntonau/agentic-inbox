...
export default function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm max-w-none focus:outline-none min-h-[180px] p-3 text-sm [&_blockquote]:border-l-2 [&_blockquote]:border-border [&_blockquote]:pl-3 [&_blockquote]:text-text-muted [&_blockquote]:bg-tx-card-hover [&_blockquote]:py-1 [&_blockquote]:my-2 [&_blockquote]:text-xs [&_blockquote]:rounded-r-sm",
      },
    },
    onUpdate: ({ editor }) => {
  ...
  return (
    <div className="rounded-lg border border-border overflow-hidden flex flex-col h-full">
      {/* Toolbar */}
      <div className="flex flex-wrap items-center gap-0.5 bg-bg px-2 py-1.5 border-b border-border shrink-0">
        {/* Text formatting */}
        ...
        <div className="mx-1 h-5 w-px bg-card-light" />
