    ...
    <div className={className}>
      {showHeading && (
        <div className="flex items-center gap-2 mb-2">
          <PaperclipIcon size={14} className="text-text-muted" />
        ...
        {files.map((attachment) => {
          ...
          if (isImage && onPreviewImage) {
            return (
              <button
                ...
                className="flex items-center gap-2 rounded-md border border-border px-3 py-2 transition-colors hover:bg-tx-card-hover text-sm text-left"
              >
                <ImageIcon size={16} className="text-text-muted shrink-0" />
                <span className="text-text-bright font-medium truncate max-w-[140px]">
                  {attachment.filename}
                </span>
          ...
          return (
            <a
              ...
              className="flex items-center gap-2 rounded-md border border-border px-3 py-2 no-underline transition-colors hover:bg-tx-card-hover text-sm"
            >
