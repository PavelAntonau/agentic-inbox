...
export const mailboxMigrations: Migration[] = [
  ...
  {
    // No txn() wrapper: multi-statement migration with ALTER TABLE.
    // Cloudflare DO runtime forbids SQL-level transactions; idempotent
    // guards (IF NOT EXISTS / IF NOT EXISTS) keep this re-runnable.
    name: "9_threads_and_email_parent_id",
    sql: `
            ...
            ALTER TABLE emails ADD COLUMN parent_id TEXT;
